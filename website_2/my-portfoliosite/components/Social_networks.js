        ...
        <section className = {styles.social_networks_container}>
            ...
            <Link  href='https://github.com/AbraaoMorais' passHref>
                <a target="_blank" rel="noopener" title="Github">
                    <svg className = {styles.icon_network_resize} id="Icon_awesome-github" data-name="Icon awesome-github" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24.693 24.051">
            ...
            {/* -------- behance ---------*/}
            <Link  href='https://www.behance.net/abraaomorais' passHref>
                <a target="_blank" rel="noopener" title="Behance">
                    <svg className = {styles.icon_network} id="Icon_awesome-behance-square" data-name="Icon awesome-behance-square" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 23.207 23.207">
            ...
            {/* -------- facebook ---------*/}
            <Link  href='https://www.facebook.com/abraao.morais.tec' passHref>
                <a target="_blank"  rel="noreferrer noopener" title="Facebook">
                    <svg className = {styles.icon_network} id="Icon_awesome-facebook" data-name="Icon awesome-facebook" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 23.693 23.538">
             ...
             {/* -------- instagram ---------*/}
            <Link  href='https://www.instagram.com/abraao_morais1/' passHref >
            ...
            {/* -------- whatsapp ---------*/}
            <Link  href='https://github.com/AbraaoMorais' passHref >
                <a target="_blank" rel="noreferrer noopener" title="Whatsapp">
                    <svg  className = {styles.icon_network} id="Icon_ionic-logo-whatsapp" data-name="Icon ionic-logo-whatsapp" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 23.207 23.207">
