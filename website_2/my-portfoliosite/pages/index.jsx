                    ...
                    <section className= {styles.side_right_container}>
                        ...
                        <div className={styles.container_tech}>
                            ...
                            <div className = {styles.container_tech_itens}>
                                ...
                                <div className = {styles.tech_iten}>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 65.527 66.36">
                                ...
                                <div className = {styles.tech_iten}>
                                    <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 52.987 60.32">
                                ...
                                <div className = {styles.tech_iten}>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 61.768 60">
                                ...
                                <div className = {styles.tech_iten}>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 59.14 59.64">
                                ...
                                <div className = {styles.tech_iten}>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 55 59.64">
                                ...
                                <div className = {styles.tech_iten}>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 55.896 59.96">
