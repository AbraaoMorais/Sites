                        ...
                        <div className={styles.container_tech}>
                            ...
                            <div className = {styles.container_tech_itens}>
                                <div className = {styles.tech_iten}>
                                    <svg height="40" width="50" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 55 60">
                                ...
                                <div className = {styles.tech_iten}>
                                    <svg height="40" width="50" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 52.987 60.32">
                                ...
                                <div className = {styles.tech_iten}>
                                    <svg height="40" width="50" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 61.768 60">
                                ...
                                <div className = {styles.tech_iten}>
                                    <svg height="40" width="50" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 59.14 59.64">
                                ...
                                <div className = {styles.tech_iten}>
                                    <svg height="40" width="50" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 55 59.64">
                                ...
                                <div className = {styles.tech_iten}>
                                    <svg height="40" width="50" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 55.896 59.96">
                                ...
                                <div className = {styles.tech_iten}>
                                        <svg height="40" width="50" viewBox=".1 16.7 2472.8 1996.5" xmlns="http://www.w3.org/2000/svg">
                                            <path d="m2006.5 1485.6c-98.8 100.8-237 157.8-386.7 158-149.8.3-288.1-56.3-386.9-156.8-48.3-49-83.7-105.2-105.7-165.3-21.5-59-29.7-122.1-24.2-184.6 5.3-61 23.3-120.3 53-173.9 28.9-52.4 68.6-99.7 117.6-139.7 96-78.3 218.2-120.6 346.2-120.8s250.1 41.9 346.2 119.8c48.9 39.9 88.6 87 117.4 139.3 29.7 53.6 47.8 112.8 53.1 173.8 5.5 62.6-2.8 125.6-24.3 184.7-22 60-57.5 116.3-105.7 165.5z" fill="#fff"/><path d="m1300.4 1143.3c4.5-81.5 44.5-153.4 104.7-204.3 59.1-50.1 138.7-80.6 225.4-80.6 86.8.1 166.3 30.6 225.4 80.6 60.2 51 100.2 122.8 104.8 204.3 4.6 83.8-29.1 161.7-88.2 219.4-60.2 58.7-146 95.6-242 95.6s-181.9-36.9-242.1-95.6c-59-57.7-92.6-135.6-88-219.4z" fill="#005385"/><path d="m774.5 1308.3c.6 31.8 10.8 93.8 26 142.3 32.1 102.5 86.5 197.4 162.3 281 77.8 85.9 173.4 154.9 284 203.8 116.3 51.5 242.2 77.8 372.9 77.5 130.7-.2 256.6-26.9 372.8-78.8 110.5-49.5 206.1-118.7 283.8-204.8 75.7-84 130-179 162.1-281.5 16-51.1 26.3-103.8 30.5-157.1 4-52 2.3-104.4-5-156.1-14.4-101.4-49.5-196.5-103.5-283.2-49.5-79.6-113.1-149.4-188.8-208.2l.1-.1-763.8-586.4c-.6-.5-1.3-1.1-1.9-1.6-50.3-38.4-134.5-38.3-189.6.3-55.8 39-62.1 103.5-12.6 144.2l-.2.1 318.6 259.2-971.3 1h-1.3c-80.2.1-157.4 52.8-172.7 119.3-15.6 67.8 38.9 124 122.4 124.4l-.1.3 492.3-1-878.5 674.3c-1.1.9-2.3 1.7-3.3 2.5-82.8 63.4-109.6 169-57.5 235.8 53 67.9 165.6 68 249.4.3l479.4-392.3s-7 53-6.5 84.8zm1232 177.3c-98.8 100.8-237 157.8-386.7 158-149.8.3-288.1-56.3-386.9-156.8-48.3-49-83.7-105.2-105.7-165.3-21.5-59-29.7-122.1-24.2-184.6 5.3-61 23.3-120.3 53-173.9 28.9-52.4 68.6-99.7 117.6-139.7 96-78.3 218.2-120.6 346.2-120.8s250.1 41.9 346.2 119.8c48.9 39.9 88.6 87 117.4 139.3 29.7 53.6 47.8 112.8 53.1 173.8 5.5 62.6-2.8 125.6-24.3 184.7-22 60-57.5 116.3-105.7 165.5z" fill="#ff7021"/>
                                        </svg>
                                        <p>Blender 3D</p>
                                    </div>
                            </div>
